...
var AbstractConnection_1 = __importDefault(require("./AbstractConnection"));
...
var MySQLConnection = /** @class */ (function (_super) {
    ...
    MySQLConnection.prototype.connect = function () {
        var connection = MySQLConnection.connection = promise_1.default.createPool({
